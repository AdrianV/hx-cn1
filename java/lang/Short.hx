...
@:native("java.lang.Short") extern class ShortClass extends java.lang.Object implements Comparable<Short>
{
	...
	@:overload override function equals(param1 : Dynamic) : Bool;
	@:overload override function hashCode() : Int;
	@:overload override function toString() : String;
	...
	function shortValue(): java.types.Int16;
}
