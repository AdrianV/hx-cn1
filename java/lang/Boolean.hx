...
@:native("java.lang.Boolean") extern class BooleanClass extends Object implements Comparable<Boolean>
{
	...
	@:overload public override function equals(param1 : Dynamic) : Bool;
	@:overload public override function hashCode() : Int;
	@:overload public override function toString() : String;
